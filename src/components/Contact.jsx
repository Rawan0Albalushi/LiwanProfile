...
import { Mail, Phone, Twitter, Linkedin, Instagram, MapPin, Clock, Code2, MessageCircle } from 'lucide-react';
...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, href: '#', label: 'LinkedIn', gradient: 'from-liwan-teal to-liwan-blue' },
